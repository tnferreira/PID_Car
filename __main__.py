...
'''
pid_car1 = pid_car.Car(race.client, race.sample_time, 'SetCarName1', race.mode_input, filename='run-fast4-old.pickle', show_profile=False, show_pid=True) # Give the car the name you want
cars = [pid_car1]
