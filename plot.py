...
class Plot:
    ...
    def create_figures(self):
        ...
        self.lines.append(self.fig1_axs[4].plot([], lw=lw, label='Speed Proportional Term')[0])
        self.lines.append(self.fig1_axs[4].plot([], lw=lw, label='Speed Derivative Term')[0])
        self.lines.append(self.fig1_axs[4].plot([], lw=lw, label='Speed Integral Term')[0])

        self.lines.append(self.fig1_axs[5].plot([], lw=lw, label='Steering Proportional Term')[0])
        self.lines.append(self.fig1_axs[5].plot([], lw=lw, label='Steering Derivative Term')[0])
        self.lines.append(self.fig1_axs[5].plot([], lw=lw, label='Steering Integral Term')[0])
    ...
    def adjust_axis_limits(self):
        ...
        self.fig1_axs[4].set_ylabel('Speed PID Terms')
        #self.fig1_axs[4].set_ylim([-0.5, 0.5])
        # ax2.legend()

        self.fig1_axs[5].set_ylabel('Steering PID Terms')
        # self.fig1_axs[5].set_ylim([-0.5, 0.5])
        # ax2.legend()
    ...
    def update(self, car):
        ...
        if self.blit:
            ...
            self.fig1_axs[4].draw_artist(self.lines[6])
            self.fig1_axs[4].draw_artist(self.lines[7])
            self.fig1_axs[4].draw_artist(self.lines[8])

            self.fig1_axs[5].draw_artist(self.lines[9])
            self.fig1_axs[5].draw_artist(self.lines[10])
            self.fig1_axs[5].draw_artist(self.lines[11])
