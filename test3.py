...
path_planner = planning.PathPlanner(epsilon=1, sample_time=0.01, number_samples=500, min_distance=3)
path_planner.update_reference_profile_from_recorded_waypoints(waypoints_x, waypoints_y, waypoints_v)
next_waypoint_x, next_waypoint_y, next_waypoint_y, completed_lap = path_planner.get_next_reference_profile_waypoint(
    current_vehicle_position_x, current_vehicle_position_y, current_vehicle_speed, current_vehicle_track_angle)

path_planner.show_reference_profile()
